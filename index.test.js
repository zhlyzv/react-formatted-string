...
test('Returns multiple string replacements', () => {
    const result = formattedString('The {0} brown {1} jumps over the lazy {2}.', 'quick', 'fox', 'dog')
...
test('Returns the same string if there is nothing to replace', () => {
    const noMatches = 'Nothing to replace here.'
    expect(() => formattedString(noMatches).toEqual(noMatches))
})
